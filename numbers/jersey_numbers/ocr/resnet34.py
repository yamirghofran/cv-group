...
class ResNetOCR:
    """Load a trained ResNet-34 checkpoint and predict jersey numbers from BGR crops."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Fine-tune ResNet-34 on jersey number crops.")
    ...
    parser.add_argument("--frozen-epochs", type=int, default=5, help="Epochs with backbone frozen.")
    parser.add_argument("--epochs", type=int, default=20, help="Epochs after unfreezing.")
