...
from jersey_numbers.ocr.resnet18 import load_checkpoint, _transforms
...
def evaluate(
    ...
    from jersey_numbers.ocr.resnet18 import resolve_device
...
def _plot_confusion_matrix(
    ...
    ax.set_ylabel("True")
    ax.set_title("ResNet-18 Jersey Number Confusion Matrix (row-normalised)")
    plt.tight_layout()
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate ResNet-18 jersey number classifier.")
